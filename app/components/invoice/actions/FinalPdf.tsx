...
export default function FinalPdf() {
    const {
        ...
        saveInvoice,
        sendPdfToMail,
        invoicePdfLoading, // extract the loading state
    } = useInvoiceContext();
    ...
    return (
        <>
            ...
            <div className="flex flex-wrap gap-2 my-1">
                ...
                <BaseButton
                     tooltipLabel="Upload invoice PDF"
                     onClick={uploadPdf}
                     size="sm"
                     variant={"outline"}
                    disabled={invoicePdfLoading} // disable the button when loading
                    >
                    {invoicePdfLoading ? "Uploading..." :
                    <DownloadCloudIcon className="w-5 h-5" /> }
                    Upload
                    </BaseButton>
